(function (win, doc) {
  ...
  let ray, raf;
  let tag = null;
  const apple = new Audio('https://cdn.jsdelivr.net/gh/Alexprud09/21@3bb5165aacd9abaf6586fb9902fbcef2192487ad/apple.mp3')
  const semen = new Audio('https://cdn.jsdelivr.net/gh/Alexprud09/21@3bb5165aacd9abaf6586fb9902fbcef2192487ad/semen.mp3')
